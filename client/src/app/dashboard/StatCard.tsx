...
const StatCard = ({title, primaryIcon, details, dateRange}: StatCardProps) => {
  ...
  return (
    <div className='md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl justify-between'>
        <div>
            ...
            <div className="flex-1">
                {details.map((detail,index)=> (
                        ...
                        <div className="grid grid-cols-3 items-center justify-between my-4">
                            ...
                            <span className="font-bold text-gray-500 text-center">{detail.amount}</span>
