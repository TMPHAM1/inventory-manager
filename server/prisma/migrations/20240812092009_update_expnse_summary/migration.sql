/*
  ...
  - You are about to drop the column `totalPurchased` on the `ExpenseSummary` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "ExpenseSummary" DROP COLUMN "totalPurchased",
